...
@app.route('/')
def home():
    return render_template("Homepage.html", page_title='Product Dashboard', topLeft=topLeftChartGenerator.generatechart(), topRight=topRightChartGenerator.generatechart(), bottomLeft=bottomLeftChartGenerator.generatechart(), bottomRight=bottomRightChartGenerator.generatechart())
